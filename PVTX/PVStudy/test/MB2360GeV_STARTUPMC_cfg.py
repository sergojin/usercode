...
# Input
#======================================
process.load("UserCode.PVStudy.MinBias_Summer09_MC_STARTUP3X_V8L_2360GeV_v1_cff")
...
process.ana.OutputFileName = 'pvtxana_ntuple_MB2360GeV_STARTUPMC.root'
process.ana.histoFileName = cms.untracked.string('pvtxana_hist_MB2360GeV_STARTUPMC.root') 
