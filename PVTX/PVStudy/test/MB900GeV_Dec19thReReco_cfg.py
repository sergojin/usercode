...
# Input
#======================================
process.load("UserCode.PVStudy.MinBias900GeV_BSCNOBEAMHALO_Dec19thSkim_v1_cff")
...
process.bit40 = hltLevel1GTSeed.clone(
    ...
    L1SeedsLogicalExpression = cms.string('(40 OR 41) AND 0 AND NOT (36 OR 37 OR 38 OR 39)')
    )
...
process.ana.OutputFileName = 'pvtxana_ntuple_MB900GeV_Dec19thReReco.root'
process.ana.histoFileName = cms.untracked.string('pvtxana_hist_MB900GeV_Dec19thReReco.root')
