...
# Input
#======================================
process.load("UserCode.PVStudy.MinBias_Summer09_MC_STARTUP3X_V8K_900GeV_v1_cff")
...
process.ana.OutputFileName = 'pvtxana_ntuple_MB900GeV_STARTUPMC.root'
process.ana.histoFileName = cms.untracked.string('pvtxana_hist_MB900GeV_STARTUPMC.root')
